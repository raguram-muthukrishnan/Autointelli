...
export interface ApiCtaInquiryCtaInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Contact and inquiry form submissions';
    displayName: 'CTA Inquiry';
    pluralName: 'cta-inquiries';
    singularName: 'cta-inquiry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    calendly_requested: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    service_requested: Schema.Attribute.String;
    source_page: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    slug: Schema.Attribute.UID<'title'>;
    speakers: Schema.Attribute.String;
...
export interface ApiJobApplicationJobApplication
  ...
  info: {
    description: 'Applications submitted by job seekers';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    current_company: Schema.Attribute.String;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_remote: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewsletterSubscriptionNewsletterSubscription
  ...
  info: {
    description: 'Stores newsletter subscription preferences';
  ...
  attributes: {
    categories: Schema.Attribute.JSON & Schema.Attribute.DefaultTo<[]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email &
...
export interface ApiPartnerRequestPartnerRequest
  ...
  attributes: {
    about_business: Schema.Attribute.Text & Schema.Attribute.Required;
    business_email: Schema.Attribute.Email & Schema.Attribute.Required;
...
export interface ApiResourceDownloadResourceDownload
  extends Struct.CollectionTypeSchema {
  collectionName: 'resource_downloads';
  info: {
    description: 'Track resource downloads with email capture';
    displayName: 'Resource Download';
    pluralName: 'resource-downloads';
    singularName: 'resource-download';
  };
  options: {
    comment: '';
    draftAndPublish: false;
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloadedAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resourceName: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    resourceUrl: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Downloadable resources like PDFs and CSVs';
...
export interface ApiVisitorVisitor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    firstVisit: Schema.Attribute.DateTime;
    ipAddress: Schema.Attribute.String;
    landingPage: Schema.Attribute.String;
    lastVisit: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::visitor.visitor'
    ...
    pageViews: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userAgent: Schema.Attribute.Text;
    visitCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::resource-download.resource-download': ApiResourceDownloadResourceDownload;
